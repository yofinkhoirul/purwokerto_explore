package com.tubes.wisata.model;
...
@Entity(tableName = "tbl_wisata")
public class ModelWisata implements Parcelable {
    ...
    public static final Creator<ModelWisata> CREATOR = new Creator<ModelWisata>() {
        @Override
        public ModelWisata createFromParcel(Parcel source) {
            return new ModelWisata(source);
        }
