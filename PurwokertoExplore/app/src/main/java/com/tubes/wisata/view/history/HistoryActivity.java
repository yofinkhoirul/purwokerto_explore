...
import com.tubes.wisata.viewmodel.WisataViewModel;
...
public class HistoryActivity extends AppCompatActivity implements HistoryAdapter.HistoryAdapterCallback{
    ...
    List<ModelWisata> modelWisataList = new ArrayList<>();
    ...
    private void setInitLayout() {
        ...
        historyAdapter = new HistoryAdapter(this, modelWisataList, this);
    ...
    private void setViewModel() {
        wisataViewModel = ViewModelProviders.of(this).get(WisataViewModel.class);
        wisataViewModel.getDataWisata().observe(this, modelLaundryList -> {
    ...
    @Override
    public void onDelete(ModelWisata modelWisata) {
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setMessage("Hapus riwayat ini?");
        alertDialogBuilder.setPositiveButton("Ya, Hapus", (dialogInterface, i) -> {
            int uid = modelWisata.uid;
            wisataViewModel.deleteDataById(uid);
